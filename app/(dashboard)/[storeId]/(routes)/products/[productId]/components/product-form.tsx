...
export const ProductForm: React.FC<ProductFormProps> = ({ initialData, categories, colors, sizes }) => {
  ...
  // これもすばらしい書き方
  const title = initialData ? 'Edit Pruduct' : 'New Product';
  ...
  console.log('now image', form.watch('images'));
  console.log('now name', form.watch('name'));
  console.log('now price', form.watch('price'));
  console.log('now categoryId', form.watch('categoryId'));
  console.log('now sizeId', form.watch('sizeId'));
  console.log('now colorId', form.watch('colorId'));
  console.log('now isFeatured', form.watch('isFeatured'));
  console.log('now isArchived', form.watch('isArchived'));
